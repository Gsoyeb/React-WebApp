...
SECRET_KEY = 'django-insecure-9q!f4)!!j2y#u7^wj+w*^_fqyxrh63mp23l8#zvg%il2!d$&s)'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',  # For react front end
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',     # Important for session
